    ...
    var payWindow=function(){
        return{
            init:function(args){
                ...
                if(args.customer !== void(0)&&!isObject(params.customer)) { config.error=!0;alert("Customer information should be an object array"); }
                ...
                if(params.customer && !config.error)
                {
                    try {
                        for (var key in params.customer) {
                            var value = params.customer[key];
                            params[key]=value;
                        }
                    }catch(err) { }
